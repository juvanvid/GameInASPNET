<%@ Page Title="Register" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="Register.aspx.cs" Inherits="GameInASPNET.Account.Register" %>
...
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
	...
	<script type = "text/javascript" src = "../Scripts/birthdayConstructor.js" ></script>
                ...
                <ContentTemplate>
                    ...
                    <div class="accountInfo">
                        ...
                        <p class="submitButtonn">
                            <asp:Button class="submitButton" ID="CreateUserButton" runat="server" CommandName="MoveNext" Text="Create User" 
                                 ValidationGroup="RegisterUserValidationGroup"/>
                        </p>
                    </div>
                </ContentTemplate>
