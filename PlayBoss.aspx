<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="PlayBoss.aspx.cs" Inherits="GameInASPNET.PlayBoss" %>
...
<div id="wrapper_play">		
	<div id="menu_play">
		...
		<a class="switchSelectedButton" href="PlayBoss.aspx">Play a Boss</a>
		<a class="switchButton" href="PlayAchv.aspx">Achievement Overview</a>
	</div>
	
	<div id="content_play">
		<script type = "text/javascript" >
		    getBossesForUser("user");
		</script>
	</div>
</div>
</asp:Content>
